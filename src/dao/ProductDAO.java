        ...
        public void removeProduct(int id){
            ...
            public String showInfo(String title){
                ...
                if(resultSet.next()){
                    ...
                    String infos = "[ID] = "+id+", [title] = "+titl+", [category] = "+category+", [price] = "+price;
                    return infos;
            ...
            public String showInfo(int id){
                ...
                if(resultSet.next()){
                    ...
                    String category = resultSet.getString("category");                    
                    this.price = resultSet.getDouble("price");                  
                    String infos = "[ID]= "+prodId+",[title]= "+title+",[category]= "+category+",[price]= "+price;
                    return infos;
            ...
            public void sortAlph(){
                try(Connection conn = DriverManager.getConnection(MYSQL_URL,MYSQL_USER,MYSQL_PASSWORD)){
                    ...
                    ResultSet resultSet = statement.executeQuery("SELECT title, price FROM "+MYSQL_TABLE+" ORDER BY title ASC LIMIT 10");
